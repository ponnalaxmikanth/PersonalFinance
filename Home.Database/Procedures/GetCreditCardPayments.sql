...
BEGIN
    ...
    select h.AccountId, h.PostedDate, h.[Description], h.Debit, h.Credit, h.Total, h.[Group], h.[SubGroup], h.TransactedBy, h.Comments
	...
	inner join AccountTypes at on at.AccountTypeId = a.AccountTypeId
		where at.AccountTypeId in (1, 3) and h.PostedDate between @fromDate and @toDate and h.[Group] = 'Credit Card'
