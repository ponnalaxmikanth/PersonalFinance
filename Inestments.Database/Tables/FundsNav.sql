CREATE TABLE [dbo].[FundsNav](
	...
	[CreateDateTime] [datetime] CONSTRAINT [DF_FundsNav_CreatedDate] DEFAULT (getdate()) NOT NULL,
	[LastUpdateDateTime] [datetime]  CONSTRAINT [DF_FundsNav_LastModifiedDate] DEFAULT (getdate()) NOT NULL,
