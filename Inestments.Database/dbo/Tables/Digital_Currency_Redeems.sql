CREATE TABLE [dbo].[Digital_Currency_Redeems] (
	...
	[CreateDate] DATETIME CONSTRAINT [DF_Digital_Currency_Redeems_CreatedDate] DEFAULT (getdate()) NOT NULL,
	[ModifiedDate] DATETIME CONSTRAINT [DF_Digital_Currency_Redeems_ModifiedDate] DEFAULT (getdate()) NOT NULL,
